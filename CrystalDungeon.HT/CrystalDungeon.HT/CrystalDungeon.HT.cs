...
public class CrystalDungeon : PhysicsGame
{
    ...
    int kerroin = 1;
    private int muutetut = 0;
    private Vector vektori = new Vector(0.5, 0.5);
    ...
    {
        PhysicsObject murskain = LuoRakenne(paikka-vektori, leveys*2, korkeus*2, Shape.Rectangle, Color.Black);
        murskain.X += 21;
        murskain.Y -= 20;
